      ...
      <main className="isolate">
        ...
        <div className="relative pt-14">
          ...
          >
            {/* chỗ này */}
            {/* <div
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#F7971E] to-[#FFD200] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
              style={{
                clipPath:
            ...
            <div className="px-6 mx-auto max-w-7xl lg:px-8">
              <div className="max-w-2xl mx-auto text-center">
                ...
                <div className="flex items-center justify-center mt-10 gap-x-6">
                  <a
                    href="#"
                    className="rounded-full bg-[#0d1f2d] text-center p-3 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                  >
                    Get started
                  </a>
                  <a
